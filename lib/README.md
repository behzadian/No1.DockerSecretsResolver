...
## ConfigurationExtensions.ProcessDockerSecrets.
(or `configuration.ProcessDockerSecrets` if you import `using No1.DockerSecretsResolver;`)
...
## ConfigurationExtensions.ProcessDockerSecretKey 
(or `configuration.ProcessDockerSecretKey` if you import `using No1.DockerSecretsResolver;`)
